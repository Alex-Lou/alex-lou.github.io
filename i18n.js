(function () {
  ...
  var I18N = {
    ...
    en: {
      ...
      'about.body3': 'On the front-end side: building <strong class="glow-accent">modern, fluid and ergonomic interfaces</strong> tailored to real user needs, on top of <strong class="glow-accent">Angular / React / Vue</strong>, with <strong class="glow-accent">Tailwind CSS</strong>, modern style frameworks and the right dose of hand-written CSS.',
    ...
    fr: {
      ...
      'about.body3': 'Côté front-end: des <strong class="glow-accent">interfaces modernes, fluides et ergonomiques</strong> centrées sur les vrais besoins utilisateurs, par-dessus <strong class="glow-accent">Angular / React / Vue</strong>, avec <strong class="glow-accent">Tailwind CSS</strong>, des frameworks de style modernes et la juste dose de CSS sur-mesure.',
      ...
      'about.level.conversational': 'Notions',
    ...
    es: {
      ...
      'about.body3': 'En el lado front-end: <strong class="glow-accent">interfaces modernas, fluidas y ergonómicas</strong> centradas en las necesidades reales del usuario, sobre <strong class="glow-accent">Angular / React / Vue</strong>, con <strong class="glow-accent">Tailwind CSS</strong>, frameworks de estilo modernos y la dosis justa de CSS hecho a mano.',
      ...
      'about.level.conversational': 'Básico',
    ...
    it: {
      ...
      'about.body3': 'Sul lato front-end: <strong class="glow-accent">interfacce moderne, fluide ed ergonomiche</strong> modellate sui veri bisogni degli utenti, sopra <strong class="glow-accent">Angular / React / Vue</strong>, con <strong class="glow-accent">Tailwind CSS</strong>, framework di stile moderni e la giusta dose di CSS scritto a mano.',
      'about.lang.fr': 'Francese',
      'about.lang.en': 'Inglese',
      'about.lang.es': 'Spagnolo',
      'about.lang.ru': 'Russo',
      'about.level.native': 'Nativo',
      'about.level.near_native': 'Quasi nativo',
      'about.level.fluent': 'Fluente',
      'about.level.conversational': 'Base',
    ...
    de: {
      ...
      'about.body3': 'Auf der Frontend-Seite: <strong class="glow-accent">moderne, flüssige und ergonomische Oberflächen</strong>, zugeschnitten auf echte Nutzerbedürfnisse, auf Basis von <strong class="glow-accent">Angular / React / Vue</strong>, mit <strong class="glow-accent">Tailwind CSS</strong>, modernen Style-Frameworks und der richtigen Dosis handgeschriebenem CSS.',
      'about.lang.fr': 'Französisch',
      'about.lang.en': 'Englisch',
      'about.lang.es': 'Spanisch',
      'about.lang.ru': 'Russisch',
      'about.level.native': 'Nativ',
      'about.level.near_native': 'Fast nativ',
      'about.level.fluent': 'Fließend',
      'about.level.conversational': 'Basis',
    ...
    pt: {
      ...
      'about.body3': 'No lado front-end: <strong class="glow-accent">interfaces modernas, fluidas e ergonómicas</strong> ajustadas às verdadeiras necessidades dos utilizadores, em cima de <strong class="glow-accent">Angular / React / Vue</strong>, com <strong class="glow-accent">Tailwind CSS</strong>, frameworks de estilo modernos e a dose certa de CSS feito à mão.',
